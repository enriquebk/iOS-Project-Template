...
let templateProjectName = "MyProject"
let templateBundleDomain = "bundleIdentifier"
let templateAuthor = "AuthorName"
let templateGithubUserName = "GithubUserName"
let templateOrganizationName = "OrganizationName"
...
let iOSProjectTemplateForlderURL = NSURL(fileURLWithPath: "TemplateProject", relativeTo: currentScriptPathURL as URL)
...
extension NSURL {
    ...
    func updateContent() {
        ...
        newContent = newContent.replacingOccurrences(of: templateGithubUserName, with: githubUserName)
...
print("\nPlease provide the following information to create your project")
...
githubUserName     = prompt(message: "Github UserName", defaultValue: githubUserName)
...
print("git remote add origin git@github.com:\(githubUserName)/\(projectName).git\n")
print(shell(args: "git", "remote", "add", "origin", "git@github.com:\(githubUserName)/\(projectName).git").output)
print("pod install \n")
print(shell(args: "pod", "install").output)
print("open \(projectName).xcworkspace\n")
print(shell(args: "open", "\(projectName).xcworkspace").output)
